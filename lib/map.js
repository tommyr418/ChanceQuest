...
const TUTORIAL_DIALOG = {
  1: "Hey you! Can you read this? It took me 1200 years to be able to manifest" +
     " my thoughts. You have no idea how boring it is to be a cloud. No!" +
     " I'm about to run out of room. Please help me by clicking any of" +
     " the tiles to my left.",
  2: "Thank you! Hey, by any chance have you seen the Dr. Strange movie?" +
     " Best movie ever! Remember the part where he traps the big baddie in an" +
     " infinite time loop? It seems I am in the same predicament. uh, kindly...",
  3: "I have watched this battle play out between red kingdom and blue" +
     " kingdom for aeons. It seems you are fated to take part in this fight" +
     " as BLUE kingdom. Listen to my instruction and win! Then I can return" +
     " to NOT EXISTING.",
  4: "",
};
