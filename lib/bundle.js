...
const MAP = {
  ...
  20: new Territory(20, [19,21], 125, 259.8, 0, "Bisque"),
  21: new Territory(21, [20,22], 200, 303.1, 0, "Bisque"),
...
class Territory {
  ...
  moveIn(color, units) {
    const pointAngle = (this.base === "Base") ? 0.5 : 0;
    this.setColor(color);
    this.hexagon.graphics.clear()
      .beginStroke("black")
      .beginFill(this.background)
      .drawPolyStar(this.x, this.y, 50, 6, pointAngle, 0);
    this.units = units;
