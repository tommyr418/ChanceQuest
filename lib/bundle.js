...
const TUTORIAL_DIALOG = {
  ...
  13: "Once again you are out of moves. At the end of each turn, players get units " +
      "added to the main base based on territories controlled. Click end turn just like before.",
  14: "A notification will tell you how many units you recruited. You will get: 1 + territories / 3"  +
      "(rounded down) + forts controlled. Forts will also recruit 1 unit each. " +
      "This time red has enough units to attack you. Be prepared. Click any tile when you are ready.",
  ...
  16: "Red has attacked your territory. When battle is initiated, both teams roll dice " +
      ...
      "defender. You can see the battle results by clicking the battle log button on the top right. " +
      "Click end turn when you are done.",
  17: "Now you know the mechanics of this game. The goal is to recruit enough units to take " +
      "over the enemy base (denoted by a star). Please click the main menu button to the right " +
      "to end this tutorial and begin a real game in 1 player or 2 player mode!",
