...
const Sandbox = __webpack_require__(3);
...
class ChanceQuest {
  ...
  startGame(tutorialMode) {
    ...
    this.game = new Game(this.map, this.gameStage, tutorialMode);
...
const Territory = __webpack_require__(4);
...
const TUTORIAL_DIALOG = {
  ...
  6: "Its now red's turn to move. Wait until red is finished",
...
class Game {
  constructor(map, stage, tutorialMode) {
    this.map = map;
    this.stage = stage;
    this.tutorialMode = tutorialMode;
